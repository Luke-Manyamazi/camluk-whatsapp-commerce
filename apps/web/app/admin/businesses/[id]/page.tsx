...
type Business = { id: string; name: string; slug: string; status: string; created_at: string; members: number; customers: number; leads: number; conversations: number; services: number; members: Member[] };
