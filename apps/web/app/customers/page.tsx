...
export default function CustomersPage() {
  ...
  useEffect(() => {
    ...
    apiFetch<{ customers: Customer[]; pagination: Pagination }>(`/api/customers?${params}`)
